...
<head>
    ...
    <title>Sign In — Bank Management</title>
    ...
    <div class="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-12">
        ...
        <div class="relative w-full max-w-md">
            <div class="mb-8 text-center">
                ...
                <p class="mt-2 text-sm text-slate-400">Sign in to access your banking dashboard.</p>
            </div>
            ...
            <p class="mt-6 text-center text-sm text-slate-400">
                ...
                <a href="/register" class="font-medium text-blue-400 transition hover:text-blue-300">Create one</a>
            </p>
        </div>
    </div>
</body>
